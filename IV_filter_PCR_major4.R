...
#'
dplyr::n_distinct(df_model$DYR_ID)  # 214916
dplyr::n_distinct(df_model$BES_ID)  # 1486
...
df1_pos <- df_model %>%
  ...
  dplyr::select(BES_ID, DYR_ID, DIM, logSCC, SCC, MILK)
...
dplyr::n_distinct(df1_neg$DYR_ID);dplyr::n_distinct(df1_neg$BES_ID) # 77811, 643
dplyr::n_distinct(df1_pos$DYR_ID);dplyr::n_distinct(df1_pos$BES_ID) # 49107, 557
dplyr::n_distinct(df2_neg$DYR_ID);dplyr::n_distinct(df2_neg$BES_ID) # 44210, 554
dplyr::n_distinct(df2_pos$DYR_ID);dplyr::n_distinct(df2_pos$BES_ID) # 41136, 528
dplyr::n_distinct(df3_neg$DYR_ID);dplyr::n_distinct(df3_neg$BES_ID) # 20063, 373
dplyr::n_distinct(df3_pos$DYR_ID);dplyr::n_distinct(df3_pos$BES_ID) # 22722, 414
dplyr::n_distinct(df4_neg$DYR_ID);dplyr::n_distinct(df4_neg$BES_ID) # 10351, 265
dplyr::n_distinct(df4_pos$DYR_ID);dplyr::n_distinct(df4_pos$BES_ID) # 12027, 300
