...
load("M:/PCR_data/nlme_wilmink2.RData")

# saving:
save.image("M:/PCR_data/nlme_wilmink2.RData")
...
nls_neg2 <- nls.multstart::nls_multstart(logSCC ~ f_wilmink(DIM, a, b, k, d),
                                         data = df2_neg,
...
#----------------------------------------------------
# nls single curves, 50 animals same herd, different parities:


# https://rpubs.com/markbneal/lactation
...
all_out_nlme_neg2 <- out_nlme_neg2 %>%
