...
# Wilmink template script for wilmink curves for PCR/curves project

# To Do:
## ggpairs to work (possible/expect could prevent stopping the pipeline)
## draw boot curve without points
## create wood curve
...
# parity 2,  DF=df_2
m_2 <- nlsList(f_nls, df1_2, start = sapply(st, mean),
...
boo_2 <- nlsBoot(nls_boo2, niter = 800)
